...
if (diameter < squareSide) {
  console.log(
    `The circle with area ${circleArea} fits into the square with area ${squareArea}`
  );
} else {
  console.log(
    `The circle with area ${circleArea} does not fit into the square with area ${squareArea}`
  );
}
